...
#     student_id=models.IntegerField()
    ...
    centre_code=models.CharField(max_length=30)  
...
class Add_Centres(models.Model):
    ...
    def __str__(self):
        return f"{self.Centrecode}"

class Add_Students(models.Model):
     Studentname=models.CharField(max_length=20,blank=False)
     Fathername=models.CharField(max_length=20,blank=False)
     Mothername=models.CharField(max_length=20,blank=False)
    #  rollno=models.AutoField(primary_key=True,default=300)
    #  rollno=models.BigAutoField(primary_key=True)
     rollno=models.BigIntegerField(primary_key=True,default=300)
     dob=models.DateField(blank=True,null=True)
     image=models.ImageField()
     Centrename=models.CharField(max_length=50,blank=False)
    #  course_name=models.CharField(max_length=150)
     duration=models.CharField(max_length=20,help_text="1 month")
     Examination_date=models.CharField(blank=True,null=True,help_text="may,2023",max_length=14)
     percnt=models.IntegerField()
     grade=models.CharField(max_length=30)
     session=models.CharField(max_length=50,help_text="March 2023-May 2023 ")
     Centrecode = models.ForeignKey(Add_Centres, on_delete=models.CASCADE, null=False ,blank=False,related_name='centre_Code')
    #  centre_code=models.IntegerField()
    #  Remark=models.CharField(max_length=10)
